...
public class AngleCorrector {
    ...
    public static double Pcoefficient = 0.025; // 0.025 is for moving forward and back; for strafing use 0.02 still (ends with error of 0 to 5). I would be a good thing to reduce that error once the target position has been reached with a turn
